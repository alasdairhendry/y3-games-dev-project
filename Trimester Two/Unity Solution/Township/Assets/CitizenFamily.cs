...
public class CitizenFamily : MonoBehaviour {
    ...
    public void SetFromNew (string firstName, string familyName, int familyID, Gender gender)
    {
        ...
        Father = new CitizenFamilyMember () { firstName = "Unknown", citizenBase = null };
        Mother = new CitizenFamilyMember () { firstName = "Unknown", citizenBase = null };
    ...
    public void GetPregnant ()
    {
        ...
        {
            isPregnant = true;
            DEBUG_CHARACTER_SPAWNER.Instance.CreateCitizen ( Partner, thisMember );
            isPregnant = false;
        }
    }
    ...
    private void SetSelectable ()
    {
        GetComponent<Inspectable> ().SetAdditiveAction ( () =>
        {
            ...
            else
            {
                ...
                {
                    return cBase.CitizenJob.profession.ToString ();
                }, "Profession", "Overview", /*ProfessionType.None.ToString(), ProfessionType.Student.ToString(),*/ ProfessionType.Worker.ToString (), ProfessionType.Gatherer.ToString () );
            }
